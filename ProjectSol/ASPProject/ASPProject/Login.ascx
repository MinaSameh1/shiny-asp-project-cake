<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Login.ascx.cs" Inherits="ASPProject.Login" %>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form runat=server id="login" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <asp:TextBox name="password" class="form-control" id="PassText" runat="server" 
                            TextMode="Password"></asp:TextBox>
                    </div>
                    <div class="col-12">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ErrorMessage="Enter Password" ControlToValidate="PassText" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-12">
                        <asp:Label ID="errLbl" runat="server" Text="" Visible=false ForeColor="Red"></asp:Label>
                    </div>
                    <div class="col-12">
                        <asp:Button ID="Button1" runat="server"  class="btn btn-primary w-100" 
